...
const routes = [
  ...
  { path: "/home/edit/:id", name: "edithome", component: EditHomeView, meta: { requiresAuth: true } }, // autentica esto
  { path: "/home/delete/:id", name: "deletehome", component: DeleteHomeView, meta: { requiresAuth: true } }, // autentica esto
  ...
  { path: "/members/delete/:id", name: "DeleteMember", component: DeleteMemberView, meta: { requiresAuth: true } }, // autentica esto
  { path: "/members/edit/:id", name: "EditMember", component: EditMemberView, meta: { requiresAuth: true } }, // autentica esto
