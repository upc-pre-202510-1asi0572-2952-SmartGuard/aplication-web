<template>
  <div class="flex flex-col w-full px-8">
    ...
    <div
      ...
      <div>
        <h2 class="text-center lg:text-4xl font-black mb-8">Registrar un nuevo hogar</h2>
    ...
    <div class="relative flex flex-col items-center gap-4 text-xl pb-8 text-black">
      ...
      <p class="font-black text-center">Sin inspiración? Intenta uno de estos nombres</p>
      <div class="flex flex-row justify-center flex-wrap gap-4  text-[16px]">
      ...
      <div class="flex flex-row flex-wrap gap-4 rounded-4xl bg-white p-8 lg:w-md shadow-2xl">
        <Button class="w-full  text-[20px]" _texto="Finalizar Registro" @click="$emit('back')" />
      </div>
    </div>
  </div>
</template>
